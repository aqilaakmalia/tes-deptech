...
@section('content')
<h4 class="py-3 mb-4"><span class="text-muted fw-light">Student /</span> Create</h4>
        ...
        <form method="POST" action="{{ route('student-create') }}" enctype="multipart/form-data">
          ...
          <div class="card-body">
            <div class="d-flex align-items-start align-items-sm-center gap-4">
              <img src="{{asset('assets/img/avatars/user.png')}}" alt="user-avatar" class="d-block w-px-120 h-px-120 rounded" id="uploadedAvatar" />
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="text" id="phone_number" name="phone_number" class="form-control" value="{{ old('phone_number') }}" placeholder="08xxxxxxxxx" />
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="text" id="student_number" name="student_number" class="form-control" value="{{ old('student_number') }}" />
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <textarea id="address" name="address" class="form-control" placeholder="123 Main St, City, Country">{{ old('address') }}</textarea>
            </div>
          </div>
