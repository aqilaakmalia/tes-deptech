<?php
  // Variables
  return [
    "creatorName" => "Aqilah Akmalia",
    "creatorUrl" => "https://themeselection.com",
    "templateName" => "SchoolHub",
    "templateSuffix" => "This application focuses on managing educational data, including admin, students, and extracurricular activities.",
